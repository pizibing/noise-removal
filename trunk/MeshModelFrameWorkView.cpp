...
{
	// TODO: Add your command handler code here
	CFileDialog dlg(TRUE, ".txt", NULL, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT, "TXT文件(*.txt)|*.txt||"); 
...
{
	// TODO: Add your command handler code here
	CFileDialog dlg(FALSE, ".txt", NULL, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT, "TXT文件(*.txt)|*.txt||"); 
